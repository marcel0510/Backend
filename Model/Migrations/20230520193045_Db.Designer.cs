            ...
            modelBuilder.Entity("Model.Entities.Building", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 484, DateTimeKind.Local).AddTicks(4288));
            ...
            modelBuilder.Entity("Model.Entities.Calendar", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 484, DateTimeKind.Local).AddTicks(5831));
                    ...
                    b.Property<DateTime>("PeridoInit")
                        .HasColumnType("datetime2")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeletedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            PeridoInit = new DateTime(2022, 8, 23, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Period = "2022B",
            ...
            modelBuilder.Entity("Model.Entities.Classroom", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 484, DateTimeKind.Local).AddTicks(8253));
            ...
            modelBuilder.Entity("Model.Entities.Group", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 485, DateTimeKind.Local).AddTicks(164));
            ...
            modelBuilder.Entity("Model.Entities.Session", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 485, DateTimeKind.Local).AddTicks(1686));
            ...
            modelBuilder.Entity("Model.Entities.Subject", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 485, DateTimeKind.Local).AddTicks(3868));
            ...
            modelBuilder.Entity("Model.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 20, 14, 30, 45, 485, DateTimeKind.Local).AddTicks(5827));
